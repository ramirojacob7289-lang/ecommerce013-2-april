...
<body class="bg-black text-white">
    <header>
        <div class="mx-auto sm:px-7 px-4 max-w-screen-xl py-10">
            <nav class="flex px-4 xl:px-0" aria-label="Global">
                <a class="text-2xl font-semibold" href="#">SaaS</a>
                <div class="flex flex-row items-center gap-5 ml-auto">
                    <a class="font-medium" href="#" aria-current="page">Home</a>
                    <a class="font-medium text-gray-600 hover:text-white" href="#prices">Prices</a>
                    <a class="font-medium text-gray-600 hover:text-white" href="#articles">Articles</a>
                </div>
            </nav>
        </div>
    </header>
        ...
        <div class="mx-auto sm:px-7 px-4 max-w-screen-xl">
            <div class="gap-x-6 px-4 py-16 pb-64 mx-auto lg:grid xl:px-0 lg:grid-cols-12">
                ...
                <div data-aos="fade-down" data-aos-delay="50" class="mt-3 text-white lg:col-span-8 lg:mt-6">
                    <h2 class="text-5xl font-medium lg:text-7xl">Create tools with <span
                            class="text-purple-500 font-bold"
                            style="font-family: 'Nothing You Could Do', cursive;">AI</span>
                        <br class="max-sm:hidden lg:hidden xl:block">you actually want
                    </h2>
                </div>
                <div data-aos="fade-down" data-aos-delay="100" class="lg:col-start-9 lg:col-span-4">
                    <p class="max-w-3xl mt-4 text-gray-400 text-[20px] leading-[26px] lg:mt-8">
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nostrum quam voluptatibus et dolor
                        filis !
                    </p>
                    <div class="flex mt-8 space-x-2 md:space-x-6">
                        <a href="" class="bg-purple-500 text-white font-bold py-2 px-6 rounded-3xl">
    ...
    <section id="imageHero" class="bg-white py-10">
        <div class="mx-auto sm:px-7 px-4 max-w-screen-xl">      
            <a data-aos="fade-down" data-aos-delay="200" href="/"
                class="object-fill border border-black video-block block mx-auto mt-[-200px] relative bg-gray-900 rounded w-full aspect-video max-w-[600px]"
                style="background-image:url(./imgs/test.png);background-size:cover;background-position:center;">
                <div class="flex items-center w-full h-full">
                    <div class="absolute bottom-[-20px] flex w-full">
                        <span class="mx-auto shadow-md bg-purple-500 rounded-3xl text-white px-6 py-2">
                            <i class="bi bi-play-circle-fill text-lg pr-2"></i>
                            Watch the video
                        </span>
                    </div>
                </div>
            ...
            <div class="flex flex-col text-center pb-20 pt-20 lg:pt-28 pb-10 text-black max-w-screen-md mx-auto">
                <h2 class="text-4xl font-medium lg:text-7xl">How it's <span class="text-purple-500 font-bold"
                        style="font-family: 'Nothing You Could Do', cursive;">works</span></h2>
            ...
            <div class="pb-10 lg:pb-20">
                <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                    <div>
                        ...
                        <h2 class="mt-4 text-xl font-semibold text-gray-800">Default Taiwindcss Config</h2>

                        <p class="mt-2 text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dignissim
                    ...
                    <div>
                        ...
                        <h2 class="mt-4 text-xl font-semibold text-gray-800">Fully Responsive Components</h2>
                    ...
                    <div>
                        ...
                        <h2 class="mt-4 text-xl font-semibold text-gray-800">RTL Languages Support</h2>
    ...
    <section id="prices" class="bg-black">

        <div class="max-w-screen-xl sm:px-7 px-4 py-10 lg:py-20 mx-auto">
            <div class="xl:items-center xl:-mx-8 xl:flex">
                <div class="flex flex-col items-center xl:items-start xl:mx-8">
                    <h2 class="text-4xl font-medium lg:text-5xl max-w-[400px]">
                        Our <span class="text-purple-500 font-bold"
                            style="font-family: 'Nothing You Could Do', cursive;">Pricing</span> Plan
                    </h2>
                    <div class="mt-4">
                ...
                <div class="flex-1 xl:mx-8">
                    <div class="mt-8 space-y-8 md:-mx-4 md:flex md:items-center md:justify-center md:space-y-0 xl:mt-0">
                        <div class="max-w-sm mx-auto border rounded-lg md:mx-4 bg-white">
                            <div class="p-6">
                                <h2 class="text-xl font-medium text-gray-700 capitalize lg:text-2xl ">
                                    Essential</h2>
                                ...
                                <h2 class="mt-4 text-2xl font-semibold text-gray-700 sm:text-3xl ">
                                    $3.00 <span class="text-base font-medium">/Month</span></h2>
                                ...
                                <button
                                    class="w-full px-4 py-2 mt-6 tracking-wide text-white capitalize transform bg-purple-500 rounded-full hover:bg-purple-600 focus:outline-none focus:bg-purple-500 focus:ring focus:ring-purple-300 focus:ring-opacity-80">
                                    Start Now
                                </button>
                            </div>
                            ...
                            <div class="p-6">
                                <h2 class="text-lg font-medium text-gray-700 capitalize lg:text-xl ">
                                    What’s included:</h2>
                                ...
                                <div class="mt-8 space-y-4">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="mx-4 text-gray-700 ">Own analytics
                                            platform</span>
                                    </div>
                        ...
                        <div class="max-w-sm mx-auto border rounded-lg md:mx-4 bg-white">
                            <div class="p-6">
                                ...
                                <h2 class="mt-4 text-2xl font-semibold text-gray-700 sm:text-3xl ">
                                    $50.00 <span class="text-base font-medium">/life time</span></h2>
    ...
    <section id="articles" class="bg-white text-black gradiant-articles">
        <div class="mx-auto p-4 sm:px-7 px-4 max-w-screen-xl">
            <div class="flex flex-col text-center pt-10 pb-10 lg:pb-20 text-black max-w-screen-md mx-auto">
                <h2 class="text-4xl font-medium lg:text-7xl">Team <span class="text-purple-500 font-bold"
                        style="font-family: 'Nothing You Could Do', cursive;">blog</span></h2>
                <span class="text-gray-600 pt-5 text-[20px] leading-[26px]">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nostrum quam voluptatibus cupidatat.
                    Lorem ipsum dolor sit amet consectetur.
                </span>
            </div>
            <ul class="grid grid-cols-12 gap-x-6 pb-10">
                <li class="col-span-12 md:col-span-4 mb-10 md:mb-0">
                    <article>
                        <header class="pb-4">
                            <figure class="rounded overflow-hidden mb-4 border border-black">
                                <a href="/" class="block">
                                    <img class="w-full hover:scale-125 transition duration-300"
                            ...
                            <ul class="flex mb-2">
                                <li class="mr-2">
                                    <a href="/"
                                        class="rounded-3xl bg-purple-500 text-white p-1 px-4 text-xs block hover:bg-purple-600">App</a>
                                </li>
                                <li class="mr-2">
                                    <a href="/"
                                        class="rounded-3xl text-gray-600 shadow p-1 px-4 text-xs block hover:bg-purple-600 hover:text-white">new</a>
                                </li>
                            </ul>
                            <h3 class="text-xl font-bold">
                                <a href="/" class="block hover:underline hover:text-purple-600">
                        ...
                        <footer class="flex items-center">
                            <div>
                                <img class="w-[50px] h-[50px] mr-2 rounded-full"
                            ...
                            <div>
                                ...
                                <a href="/" class="hover:underline">Lisa Allison</a>
                            </div>
                        </footer>
                    </article>
                </li>
                    ...
                    <article>
                        <header class="pb-4">
                            <figure class="rounded overflow-hidden mb-4 border border-black">
                                <a href="/" class="block">
                                    <img class="w-full hover:scale-125 transition duration-300"
                                        src="https://images.unsplash.com/photo-1657310209576-6595b2c68d6f?q=80&w=3572&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                        alt="">
                                </a>
                            </figure>
                            <ul class="flex mb-2">
                    ...
                    <article>
                        <header class="pb-4">
                            <figure class="rounded overflow-hidden mb-4 border border-black">
                                <a href="/" class="block">
                                    <img class="w-full hover:scale-125 transition duration-300"
                                        src="https://plus.unsplash.com/premium_photo-1664879730345-ae3381805040?q=80&w=3570&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                        alt="">
                                </a>
                            </figure>
                            <ul class="flex mb-2">
                            ...
                            <h3 class="text-xl font-bold">
                                <a href="/" class="block hover:underline hover:text-purple-600">
                                    “A new year is coming and we are full of new ideas to help you scale”
                                </a>
                            </h3>
                        </header>
                        <footer class="flex items-center">
            ...
            <div class="flex flex-col text-center pt-10 pb-10 text-black max-w-screen-md mx-auto">
                <h2 class="text-4xl font-medium lg:text-7xl">
                    <span class="text-purple-500 font-bold"
                        style="font-family: 'Nothing You Could Do', cursive;">Technos</span> we use
                </h2>
            </div>
            <div class="mx-auto mb-10">
                <div class="scroll imgBox" style="--time:20s">
                    <div>
                        <img class="grayscale" src="./imgs/logos/html.png" alt="">
                        <img class="grayscale" src="./imgs/logos/css.png" alt="">
                        <img class="grayscale" src="./imgs/logos/js.png" alt="">
                        <img class="grayscale" src="./imgs/logos/React.png" alt="">
                        <img class="grayscale" src="./imgs/logos/angular.png" alt="">
                        <img class="grayscale" src="./imgs/logos/figma.png" alt="">
                        <img class="grayscale" src="./imgs/logos/photoshop.png" alt="">
                        <img class="grayscale" src="./imgs/logos/mui.png" alt="">
                        <img class="grayscale" src="./imgs/logos/tailwind.png" alt="">
                        <img class="grayscale" src="./imgs/logos/premierePro.png" alt="">
                    </div>
                    <div>
                        <img class="grayscale" src="./imgs/logos/html.png" alt="">
                        <img class="grayscale" src="./imgs/logos/css.png" alt="">
    ...
    <section id="CTA">
        <div class="max-w-screen-xl sm:px-7 px-4 py-10 lg:py-20 mx-auto">
            <div class="p-10 lg:p-20 bg-gradient-to-b from-white to-gray-300 rounded-lg">
                <div class="lg:grid lg:grid-cols-12 items-center">
                    <div class="text-black lg:col-span-8 flex flex-col">
                        <h2 class="font-semibold text-gray-400 lg:col-span-12">AI-powered no code apps</h2>
                        <h2 class="text-4xl font-medium lg:text-7xl"><span class="text-purple-500 font-bold"
                                style="font-family: 'Nothing You Could Do', cursive;">Ready</span> to get started ?</h2>
                        <span class="text-gray-600 pt-4 text-[20px] leading-[26px]">We have a generous free tier
                            available
                            to get you started right away.
                        </span>
                    </div>
                    <div class="mt-10 lg:mt-0 lg:col-start-9 lg:col-span-4 flex">
                        <a href=""
                            class="ml-0 lg:ml-auto bg-purple-500 text-white font-bold py-2 px-8 rounded-3xl text-2xl hover:bg-purple-600">
                            Get started for free
                        </a>
                    </div>
                </div>
        ...
        <div class="max-w-screen-xl sm:px-7 px-4 py-10 lg:py-20 mx-auto">
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                <div class="sm:col-span-2">
                    <h2 class="max-w-lg text-xl font-semibold tracking-tight text-gray-800 xl:text-2xl">Subscribe our
                        <span class="text-purple-500 font-bold"
                            style="font-family: 'Nothing You Could Do', cursive;">newsletter</span> to get update.</h2>

                    <div class="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
                        <input id="email" type="text"
                            class="px-4 py-2 text-gray-700 bg-white border focus:outline-purple-500 rounded-full"
                            placeholder="Email Address">

                        <button
                            class="w-full px-6 py-2.5 text-sm font-medium tracking-wider text-white transform md:w-auto md:mx-4 bg-purple-500 rounded-full hover:bg-purple-600">
                            Subscribe
                        </button>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex flex-col items-start mt-5 space-y-2">
                        <a href="#" class="text-gray-600 hover:underline hover:text-purple-600">Home</a>
                        <a href="#" class="text-gray-600 hover:underline hover:text-purple-600">Who We Are</a>
                        <a href="#" class="text-gray-600 hover:underline hover:text-purple-600">Our Philosophy</a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex flex-col items-start mt-5 space-y-2">
                        <a href="#" class="text-gray-600 hover:underline hover:text-purple-600">Retail & E-Commerce</a>
                        <a href="#" class="text-gray-600 hover:underline hover:text-purple-600">Information
                            Technology</a>
                        <a href="#" class="text-gray-600 hover:underline hover:text-purple-600">Finance & Insurance</a>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <p class="text-black">&copy; All right reserved by <a href="https://lbegey78.gumroad.com/" class="font-semibold" target="_blank">Laurent Begey</a> • Distributed by <a href="https://themewagon.com" class="font-semibold" target="_blank">ThemeWagon</a>.</p>

                <div class="flex -mx-2">
                    <a href="#" class="mx-2 text-gray-600 hover:text-purple-600 " aria-label="Reddit">
                    ...
                    <a href="#" class="mx-2 text-gray-600 hover:text-purple-600 " aria-label="Facebook">
                        <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M2.00195 12.002C2.00312 16.9214 5.58036 21.1101 10.439 21.881V14.892H7.90195V12.002h20.442V9.80204C10.3284 8.75958 10.6845 7.72064 11.4136 6.96698C12.1427 6.21332 13.1693 5.82306 14.215 5.90204C14.9655 5.91417 15.7141 5.98101 16.455 6.10205V8.56104h25.191C14.7558 8.50405 14.3183 8.64777 14.0017 8.95171C13.6851 9.25566 13.5237 9.68693 13.563 10.124V12.002h26.334L15.891 14.893h23.563V21.881C18.8174 21.0506 22.502 16.2518 21.9475 10.9611C21.3929 5.67041 16.7932 1.73997 11.4808 2.01722C6.16831 2.29447 2.0028 6.68235 2.00195 12.002Z">
                            </path>
                        </svg>
                    </a>

                    <a href="#" class="mx-2 text-gray-600 hover:text-purple-600 " aria-label="Github">
                        <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
    ...
    <script>
        ...
        typewriter.typeString('Super tool overpowered by AI')
            .pauseFor(5000)
            .start();
    </script>
